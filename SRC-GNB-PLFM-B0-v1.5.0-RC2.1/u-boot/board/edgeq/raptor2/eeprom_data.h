...
size_t group_sizes[TOTAL_GROUPS] = { sizeof(struct eeprom_info),
	sizeof(struct board_configs),
	sizeof(struct pcie_usb_configs),
	sizeof(struct rfic_configs),
	sizeof(struct ethernet_configs),
	sizeof(struct misc_configs),
	sizeof(struct jesd_configs)
	};

char *group_names[TOTAL_GROUPS] = { "eeprom_info",
	"board_configs",
	"pcie_usb_configs",
	"rfic_configs",
	"ethernet_configs",
