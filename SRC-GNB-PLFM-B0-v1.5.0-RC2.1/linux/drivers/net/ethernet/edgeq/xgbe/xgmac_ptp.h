...
/* SSIR defines */
#define	PTP_SSIR_SSINC_MASK		0x00ff0000
#define	PTP_SSIR_SSINC_SHIFT		16
#define	PTP_SSIR_SNSINC_MASK		0x0000ff00
#define	PTP_SSIR_SNSINC_SHIFT		8

#define	PTP_MAX_NUM_PORTS		5
extern struct xgmac_priv *ptp_priv_list[];

/* For DCTCXO control */
extern int si5357_set_freq(int ppb);

#endif	/* __XGMAC_PTP_H__ */
