...
static int dwxgmac2_get_tx_status(void *data, struct xgmac_extra_stats *x,
...
static int dwxgmac2_get_rx_status(void *data, struct xgmac_extra_stats *x,
				  struct dma_desc *p)
{
...
static inline void dwxgmac2_get_timestamp(void *desc, u64 *ts)
{
...
static void dwxgmac2_init_tx_desc(struct dma_desc *p)
{
	p->des0 = 0;
	p->des1 = 0;
	p->des2 = 0;
...
const struct xgmac_desc_ops dwxgmac210_desc_ops = {
