...
{
	// EQ: power down only from u-boot.
	return 0;
...
static int mv3310_read_status_copper(struct phy_device *phydev)
{
	...
	if (!(cssr1 & MV_PCS_CSSR1_LINKUP) || !(cssr1 & MV_PCS_CSSR1_RESOLVED))
		return 0;
	phydev->link = 1;
