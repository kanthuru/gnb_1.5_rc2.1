...
#if IS_ENABLED(CONFIG_EDGEQ_APB_MMC_ADDRESSING)
...
#define SDHCI_QUIRK2_RAPTOR2_A0				(1<<19)
#define SDHCI_QUIRK2_RAPTOR2_B0				(1<<20)
#define SDHCI_QUIRK2_RAPTOR2_NON_COHERENT		(1<<21)
#define SDHCI_QUIRK2_RAPTOR2_COHERENT			(1<<22)
	int irq;		/* Device IRQ */
