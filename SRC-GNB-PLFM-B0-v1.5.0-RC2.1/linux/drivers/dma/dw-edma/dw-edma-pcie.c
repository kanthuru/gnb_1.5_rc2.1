...
struct dw_edma_pcie_data {
	...
	off_t				ll_off;
	size_t				ll_sz;
	phys_addr_t                     ll_remote_paddr;
	/* eDMA memory data location */
	enum pci_barno			dt_bar;
	off_t				dt_off;
	size_t				dt_sz;
	phys_addr_t                     dt_remote_paddr;

	/* Other */
	u32				version;
	enum dw_edma_mode		mode;
	u8				irqs;
	bool				use_remote_paddr;
};
...
static const struct dw_edma_pcie_data snps_edda_data = {
	...
	.irqs				= 1,
	.use_remote_paddr		= false,
};

static const struct dw_edma_pcie_data edgeq_edda_data = {
	/* eDMA registers location */
	.rg_bar				= BAR_0,
	.rg_off				= 0x00000000,	/* 0x3C980000 PF0_DMA_CAP */
	.rg_sz				= 0x00002000,	/*  8 Kbytes */
	/* eDMA memory linked list location */
	.ll_bar				= BAR_2,
	.ll_off				= 0xc0000000,	/* 0x3C980200 DMA_CH_CONTROL1_OFF_WRCH_0 */
	.ll_sz				= 0x00800000,	/* 8 Mbytes */
	.ll_remote_paddr		= 0x400000000ULL,
	/* eDMA memory data location */
	.dt_bar				= BAR_2,
	.dt_off				= 0x00800000,	/*  8 Mbytes */
	.dt_sz				= 0x03800000,	/* 56 Mbytes */
	.dt_remote_paddr		= 0x400000000ULL,
	/* Other */
	.version			= 0,
	.mode				= EDMA_MODE_UNROLL,
	.irqs				= 1,
	.use_remote_paddr		= true,
};
			      ...
			      const struct pci_device_id *pid)
{
	...
	if (!pdata->use_remote_paddr)
		dw->ll_region.paddr = pdev->resource[pdata->ll_bar].start;
	else
		dw->ll_region.paddr = pdata->ll_remote_paddr;
	...
	if (!pdata->use_remote_paddr)
		...
		dw->dt_region.paddr = pdata->dt_remote_paddr;
...
static const struct pci_device_id dw_edma_pcie_id_table[] = {
	...
	{ .vendor = 0x1ece, .device = PCI_ANY_ID,
		.subvendor = PCI_ANY_ID,
		.subdevice = PCI_ANY_ID, 0, 0,
		.driver_data = (kernel_ulong_t) &edgeq_edda_data },
	{ }
};
