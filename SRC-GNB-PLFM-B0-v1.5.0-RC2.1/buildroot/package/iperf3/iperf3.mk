...
IPERF3_CONF_ENV += CFLAGS="$(TARGET_CFLAGS) -D_HAVE_SCTP_H -I$(BUILD_DIR)/lksctp-tools-1.0.18/src/include/"
IPERF3_CONF_ENV += LDFLAGS="$(TARGET_LDFLAGS) -lsctp"
...
IPERF3_DEPENDENCIES += lksctp-tools
