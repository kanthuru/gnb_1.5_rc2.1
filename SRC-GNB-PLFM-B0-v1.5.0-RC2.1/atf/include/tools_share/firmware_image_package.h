...
/*
 *  UUID for each of the image types.
 *  Note: Generated using https://www.uuidgenerator.net/
 */
#define UUID_DDR_CTRL_FIRMWARE_IMAGE_1 \
	{{0x3d, 0xa0, 0xae, 0x21}, {0xb8, 0xc4}, {0x46, 0xfc}, 0x8a, 0x8e, {0xb4, 0x2a, 0x08, 0x3e, 0x01, 0x43}}

#define UUID_DDR_CTRL_FIRMWARE_IMAGE_2 \
	{{0xb8, 0x5d, 0xae, 0x2a}, {0x61, 0xaa}, {0x49, 0x7a}, 0x9a, 0x2a, {0x3e, 0x85, 0xe0, 0x2a, 0x7f, 0x25}}

#define UUID_DDR_CTRL_FIRMWARE_IMAGE_3 \
	{{0xa8, 0x40, 0xef, 0x5e}, {0xf1, 0x0d}, {0x48, 0xea}, 0x88, 0x6b, {0xcb, 0x23, 0x0b, 0x69, 0x4b, 0x9b}}

#define UUID_DDR_CTRL_FIRMWARE_IMAGE_4 \
	{{0x1d, 0xad, 0xde, 0x11}, {0xdf, 0x22}, {0x4f, 0x58}, 0xa9, 0xf9, {0x2c, 0x1a, 0x76, 0x83, 0x2f, 0xfa}}

#define UUID_RUNTIME_BSS_IMAGE \
	{{0x52, 0xa2, 0x13, 0xc7}, {0x92, 0x3b}, {0x42, 0xbb}, 0xa5, 0x28, {0xcc, 0x2c, 0xd5, 0x5d, 0x74, 0xf8}}
