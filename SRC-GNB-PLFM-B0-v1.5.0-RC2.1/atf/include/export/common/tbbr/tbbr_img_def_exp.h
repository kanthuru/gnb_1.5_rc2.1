...
/* DDR Controller Firmware Images. */
#define  DDR_CTRL_FW_IMAGE1_ID          U(31)
#define  DDR_CTRL_FW_IMAGE2_ID          U(32)
#define  DDR_CTRL_FW_IMAGE3_ID          U(33)
#define  DDR_CTRL_FW_IMAGE4_ID          U(34)
#define  RUNTIME_BSS_IMAGE_ID           U(35)


/* Define size of the array */
#if defined(SPD_spmd)
#define MAX_SP_IDS			U(8)
#define MAX_NUMBER_IDS			MAX_SP_IDS + U(36)
#else
#define MAX_NUMBER_IDS			U(36)
#endif
