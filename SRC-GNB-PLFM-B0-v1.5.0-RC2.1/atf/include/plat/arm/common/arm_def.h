...
#if PLAT_raptor2
#define ARM_TRUSTED_SRAM_BASE		UL(0x80100000)
#else
...
#ifdef PLAT_raptor2
#define ARM_SYS_TIMCTL_BASE            UL(0x70200000)
#define ARM_SYS_CNT_BASE_S             UL(0x70320000)
#define ARM_SYS_CNT_BASE_NS            UL(0x70330000)
#else
