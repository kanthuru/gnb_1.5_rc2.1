...
/* Raptor2 specific image data */
static unsigned char r2_ddr_ctrl_img1_hash_buf[HASH_DER_LEN];
static unsigned char r2_ddr_ctrl_img2_hash_buf[HASH_DER_LEN];
static unsigned char r2_ddr_ctrl_img3_hash_buf[HASH_DER_LEN];
static unsigned char r2_ddr_ctrl_img4_hash_buf[HASH_DER_LEN];
static unsigned char r2_runtime_bss_img_hash_buf[HASH_DER_LEN];
...
/* Raptor2 specific images */
static auth_param_type_desc_t r2_ddr_ctrl_img1_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, R2_DDR_CTRL_IMG1_HASH_OID);
static auth_param_type_desc_t r2_ddr_ctrl_img2_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, R2_DDR_CTRL_IMG2_HASH_OID);
static auth_param_type_desc_t r2_ddr_ctrl_img3_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, R2_DDR_CTRL_IMG3_HASH_OID);
static auth_param_type_desc_t r2_ddr_ctrl_img4_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, R2_DDR_CTRL_IMG4_HASH_OID);
static auth_param_type_desc_t r2_runtime_bss_img_hash = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_HASH, R2_RUNTIME_BSS_IMG_HASH_OID);
...
static const auth_img_desc_t non_trusted_fw_content_cert = {
	...
	.authenticated_data = (const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
		...
		[2] = {
			.type_desc = &r2_ddr_ctrl_img1_hash,
			.data = {
				.ptr = (void *)r2_ddr_ctrl_img1_hash_buf,
				.len = (unsigned int)HASH_DER_LEN
			}
		},
		[3] = {
			.type_desc = &r2_ddr_ctrl_img2_hash,
			.data = {
				.ptr = (void *)r2_ddr_ctrl_img2_hash_buf,
				.len = (unsigned int)HASH_DER_LEN
			}
		},
		[4] = {
			.type_desc = &r2_ddr_ctrl_img3_hash,
			.data = {
				.ptr = (void *)r2_ddr_ctrl_img3_hash_buf,
				.len = (unsigned int)HASH_DER_LEN
			}
		},
		[5] = {
			.type_desc = &r2_ddr_ctrl_img4_hash,
			.data = {
				.ptr = (void *)r2_ddr_ctrl_img4_hash_buf,
				.len = (unsigned int)HASH_DER_LEN
			}
		},
		[6] = {
			.type_desc = &r2_runtime_bss_img_hash,
			.data = {
				.ptr = (void *)r2_runtime_bss_img_hash_buf,
				.len = (unsigned int)HASH_DER_LEN
			}
		}
	}
...
/* Raptor2 specific TBBR definition. */
static const auth_img_desc_t r2_ddr_ctrl_img1 = {
	.img_id = DDR_CTRL_FW_IMAGE1_ID,
	.img_type = IMG_RAW,
	.parent = &non_trusted_fw_content_cert,
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
			...
			.param.hash = {
				.data = &raw_data,
				.hash = &r2_ddr_ctrl_img1_hash
			}
		}
	}
};
static const auth_img_desc_t r2_ddr_ctrl_img2 = {
	.img_id = DDR_CTRL_FW_IMAGE2_ID,
	.img_type = IMG_RAW,
	.parent = &non_trusted_fw_content_cert,
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
			...
			.param.hash = {
				.data = &raw_data,
				.hash = &r2_ddr_ctrl_img2_hash
			}
		}
	}
};
static const auth_img_desc_t r2_ddr_ctrl_img3 = {
	.img_id = DDR_CTRL_FW_IMAGE3_ID,
	.img_type = IMG_RAW,
	.parent = &non_trusted_fw_content_cert,
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
			...
			.param.hash = {
				.data = &raw_data,
				.hash = &r2_ddr_ctrl_img3_hash
			}
		}
	}
};
static const auth_img_desc_t r2_ddr_ctrl_img4 = {
	.img_id = DDR_CTRL_FW_IMAGE4_ID,
	.img_type = IMG_RAW,
	.parent = &non_trusted_fw_content_cert,
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
			...
			.param.hash = {
				.data = &raw_data,
				.hash = &r2_ddr_ctrl_img4_hash
			}
		}
	}
};
static const auth_img_desc_t r2_runtime_bss_img = {
	.img_id = RUNTIME_BSS_IMAGE_ID,
	.img_type = IMG_RAW,
	.parent = &non_trusted_fw_content_cert,
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
...
static const auth_img_desc_t * const cot_desc[] = {
	...
	[DDR_CTRL_FW_IMAGE1_ID]                 =       &r2_ddr_ctrl_img1,
	[DDR_CTRL_FW_IMAGE2_ID]                 =       &r2_ddr_ctrl_img2,
	[DDR_CTRL_FW_IMAGE3_ID]                 =       &r2_ddr_ctrl_img3,
	[DDR_CTRL_FW_IMAGE4_ID]                 =       &r2_ddr_ctrl_img4,
	[RUNTIME_BSS_IMAGE_ID]                  =       &r2_runtime_bss_img,
};
#endif
