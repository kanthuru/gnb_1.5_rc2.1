...
static ext_t tbb_ext[] = {
	...
	[DDR_CTRL_IMG1_EXT] = {
		.oid = R2_DDR_CTRL_IMG1_HASH_OID,
		.opt = "r2-ddr-ctrl-img-1",
		.help_msg = "DDR Controller Image 1",
		.sn = "DDRCtrlImage1",
		.ln = "DDR Controller Image 1 hash (SHA256)",
		.asn1_type = V_ASN1_OCTET_STRING,
		.type = EXT_TYPE_HASH,
		.optional = 1
	},
	[DDR_CTRL_IMG2_EXT] = {
		.oid = R2_DDR_CTRL_IMG2_HASH_OID,
		.opt = "r2-ddr-ctrl-img-2",
		.help_msg = "DDR Controller Image 2",
		.sn = "DDRCtrlImage2",
		.ln = "DDR Controller Image 2 hash (SHA256)",
		.asn1_type = V_ASN1_OCTET_STRING,
		.type = EXT_TYPE_HASH,
		.optional = 1
	},
	[DDR_CTRL_IMG3_EXT] = {
		.oid = R2_DDR_CTRL_IMG3_HASH_OID,
		.opt = "r2-ddr-ctrl-img-3",
		.help_msg = "DDR Controller Image 3",
		.sn = "DDRCtrlImage3",
		.ln = "DDR Controller Image 3 hash (SHA256)",
		.asn1_type = V_ASN1_OCTET_STRING,
		.type = EXT_TYPE_HASH,
		.optional = 1
	},
	[DDR_CTRL_IMG4_EXT] = {
		.oid = R2_DDR_CTRL_IMG4_HASH_OID,
		.opt = "r2-ddr-ctrl-img-4",
		.help_msg = "DDR Controller Image 4",
		.sn = "DDRCtrlImage4",
		.ln = "DDR Controller Image 4 hash (SHA256)",
		.asn1_type = V_ASN1_OCTET_STRING,
		.type = EXT_TYPE_HASH,
		.optional = 1
	},
	[BSS_RUNTIME_IMG_EXT] = {
		.oid = R2_RUNTIME_BSS_IMG_HASH_OID,
		.opt = "r2-runtime-bss-img",
		.help_msg = "BSS Runtime Image",
		.sn = "BSSRuntimeImage",
		.ln = "BSS Runtime Image hash (SHA256)",
		.asn1_type = V_ASN1_OCTET_STRING,
		.type = EXT_TYPE_HASH,
		.optional = 1
	},
