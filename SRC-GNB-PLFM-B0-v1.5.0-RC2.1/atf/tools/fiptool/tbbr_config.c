...
toc_entry_t toc_entries[] = {
	...
	/* Start of Raptor2 specific images. */
	{
		.name = "R2 DDRCTRL Image 1",
		.uuid = UUID_DDR_CTRL_FIRMWARE_IMAGE_1,
		.cmdline_name = "r2-ddr-ctrl-img-1"
	},
	{
		.name = "R2 DDRCTRL Image 2",
		.uuid = UUID_DDR_CTRL_FIRMWARE_IMAGE_2,
		.cmdline_name = "r2-ddr-ctrl-img-2"
	},
	{
		.name = "R2 DDRCTRL Image 3",
		.uuid = UUID_DDR_CTRL_FIRMWARE_IMAGE_3,
		.cmdline_name = "r2-ddr-ctrl-img-3"
	},
	{
		.name = "R2 DDRCTRL Image 4",
		.uuid = UUID_DDR_CTRL_FIRMWARE_IMAGE_4,
		.cmdline_name = "r2-ddr-ctrl-img-4"
	},
	{
		.name = "R2 Runtime BSS Image",
		.uuid = UUID_RUNTIME_BSS_IMAGE,
		.cmdline_name = "r2-runtime-bss-img"
	},
	/* End of Raptor2 specific images. */
	{
		.name = NULL,
		.uuid = { {0} },
		.cmdline_name = NULL,
